...
This version doesn't use the 'hurozo' Python package. We recommend that you do
use the Hurozo python package (see `hello_world.py`) so you keep up with platform changes.

Set the environment variables HUROZO_API_TOKEN and HUROZO_API_URL before running:
HUROZO_API_TOKEN: API token created in settings.
...
API_TOKEN = os.environ.get("HUROZO_API_TOKEN", "YOUR_TOKEN")
